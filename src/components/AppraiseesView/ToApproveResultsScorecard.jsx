...
export default function ToApproveResultsScorecard() {
  const navigate = useNavigate();
  ...
  useEffect(() => {
    ...
    if (performanceAreas && performanceAreas.length > 0) {
      ...
      performanceAreas.forEach((performanceArea) => {
        totalPerformanceAreasScore += performanceArea.performance_area_score;
      });
            ...
            axiosClient
              ...
              .then((res) => {
                ...
                if (res.status === 200) {
                  ...
                  navigate("/approved-appraisee-results-scorecard");
                }
              })
              .catch((err) => {
                console.log(err);
  ...
  const handleSubmitResultScorecardReject = (e) => {
    e.preventDefault();
          ...
          try {
            axiosClient
              ...
              .then((res) => {
                ...
                if (res.status === 200) {
                  swal({
                    text: "Scorecard Rejected Successfully",
                    icon: "success",
                    button: "OK!",
                  });
                  navigate("/approved-appraisee-results-scorecard");
    ...
    <>
          ...
          performanceAreas.map((area, index) => (
            <TabPanel key={index} value={value} index={index}>
              ...
              <div>
                ...
                <Typography>Name of Appraiser : __________ </Typography>
                ...
                >
                  <Typography>Designation : Commisioner General </Typography>
                  <div
      ...
      >
        <DialogContent>
          ...
          <br />
          <form
            onSubmit={handleSubmitResultScorecardReject}
            style={{ width: "500px" }}
          >
            <div
              style={{
