...
const EvaluatorApproveResultsScorecard = () => {
  ...
  return (
    <div style={{ marginLeft: "100px" }}>
      ...
      >
        ...
        >
          Evaluator View: Current Quater Approved Results Scorecard for Appraisees
        </Typography>
      </Paper>
        ...
        <MaterialReactTable
          ...
          data={appraiseeProfileData
            .map((appraisee, index) => ({
              ...
              appraiser: workPlanData[index]?.appraiser,
            }))
            .filter(
          ...
          muiTableBodyRowProps={({ row, index }) => ({
            onClick: (event) => {
              ...
              const workplanUrl = `/evaluatorcomment-selected-approved-results-scorecard?${queryParams}`;
...
export default EvaluatorApproveResultsScorecard;
