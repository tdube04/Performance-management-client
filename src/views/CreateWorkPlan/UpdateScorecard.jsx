          ...
          if (existingPerformanceArea) {
            ...
            if (existingProgram) {
              ...
              if (existingIndicatorData) {
                ...
                if (selectedMeasurement) {
                  existingIndicatorData.incremental_or_decremental = selectedMeasurement;
                } else {
                ...
                if (selectedMeasurement) {
                  existingIndicatorData.responsibleDivision = selectedMeasurement;
                } else {
                ...
                if (selectedMeasurement) {
                  existingIndicatorData.responsibleSection = selectedMeasurement;
                } else {
