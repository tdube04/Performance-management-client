...
const UpdateWorkplan2 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log("Current Indicator Data: ", currentIndicatorData);

        setCurrentProgramData(program);

        setCurrentPlanStatus("Incomplete");

        setCurrentPerformanceData(performanceAreas);
  ...
  useEffect(() => {
    ...
    console.log(currentProgramData);
    console.log(currentPerformanceData);
    console.log("Current" + currentPerformanceData);
    ...
    //   const existingProgram = currentPerformanceData.programs.find(
    //     (program) => program.name === currentProgramData
    //   );
    //   console.log(existingProgram);
    // }
  }, [currentIndicatorData, currentPerformanceData]);
  ...
  const handleUpdateIndicators = (e) => {
    ...
    const updatedPerformanceArea = performanceAreas.find(
      (area) => area.performanceArea === currentIndicatorData.performance
    );
            ...
            <form onSubmit={handleUpdateIndicators} style={{ width: "550px" }}>
              ...
              >
                ...
                <input
                  disabled
                  defaultValue={
                    currentIndicatorData && currentIndicatorData.performance
                  }
              ...
              >
                ...
                <input
                  disabled
                  defaultValue={currentProgramData && currentProgramData}
                  className="input2 animate__animated animate__bounceIn"
                  type="text"
...
export default UpdateWorkplan2;
