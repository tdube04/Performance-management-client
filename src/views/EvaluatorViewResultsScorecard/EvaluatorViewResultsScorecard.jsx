...
export default function EvaluatorViewApprovedResultsScorecard() {
  const navigate = useNavigate();
  ...
  const handleWorkPlanReject = (event) => {
    ...
    axiosClient
      ...
      .then((res) => {
        console.log(res);
        swal({
          text: `You have sent a comment of the Result Scorecard`,
          icon: "success",
          button: "OK",
        });
        navigate("/rejected");
      ...
      <div className={classes.root}>
          ...
          performanceAreas.map((area, index) => (
            <TabPanel key={index} value={value} index={index}>
              <div style={{ display: "flex", alignItems: "center" }}>
                ...
                <Typography style={{ marginTop: "-10px", marginLeft: "300px" }}>
                  Scorecard Status:{" "}
                  <span
                    style={{
                      color: "green",
        ...
        >
          <DialogContent>
            ...
            <br />
            <form onSubmit={handleWorkPlanReject} style={{ width: "500px" }}>
              <div
                style={{
                  display: "flex",
                  alignItems: "center",
